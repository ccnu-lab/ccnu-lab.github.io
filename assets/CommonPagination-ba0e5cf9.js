import{r}from"./react-f0d12c14.js";import{j as f}from"./main-3b2cc8d5.js";import{s as c}from"./styled-components.browser.esm-3a1d7e2e.js";import{g}from"./antd-59c365fd.js";const u=t=>typeof t=="function",m=t=>{const[o,a]=r.useState(t),e=r.useCallback(n=>{a(i=>{const s=u(n)?n(i):n;return s?Object.assign(Object.assign({},i),s):i})},[]);return[o,e]},S=m,p=c(g)`
  position: absolute;
  bottom: 0;
  padding-bottom: 98px;
  .ant-pagination-item {
